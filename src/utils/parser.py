...
def get_model_parser():
    ...
    model_parser.add_argument('--transformer', type=str, default='t5-base', help='transformer to use (default=robert-large)')
    ...
    model_parser.add_argument('--formatting', type=str, default='O:{O}\n\n S:{S}\n\n A:{A}\n\n', help='formatting of input text')
    return model_parser
