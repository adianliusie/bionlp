...
from ..models.pre_trained_trans import SEQ2SEQ_TRANS, LM_TRANS
from ..models.pre_trained_trans import load_seq2seq_transformer, load_LM_transformer
...
class Trainer(object):
    ...
    def train(self, args: namedtuple):
        ...
        if args.freeze_trans:
            print('NEED TO IMPLEMENT FREEZING!')
            pass
